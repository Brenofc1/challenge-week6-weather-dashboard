...
// Key access to the OpenWeather API
var APIkey = "1cbdf056fb238c0ef73f795e48d05bc7";
...
function searchHistory(searchValue) {
    // Grab value entered into search bar If there are characters entered into the search bar
    if (searchValue) {
